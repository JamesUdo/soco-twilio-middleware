...
// Base44 expects the API key in a custom `api_key` header, NOT Authorization Bearer.
// Using the wrong header makes Base44 treat the request as anonymous and reject
// it with "This app is private" when App Visibility = Private.
const headers = {
